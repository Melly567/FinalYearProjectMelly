...
from ml_package import PurchasePredictionModel, get_model_path
...
def load_model():
    ...
    model_path = get_model_path(os.path.dirname(os.path.dirname(__file__)))
    model = PurchasePredictionModel(model_path)
    return model
...
def predict(request):
    ...
    if request.method == 'POST':
        ...
        # Make prediction using our shared model package
